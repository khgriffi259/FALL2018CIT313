...
<div id="wrapper">
    ...
    <?php
		...
		$aryProductsArray = unserialize($_SESSION["aryProductsArray"]); //commonize session variable name for products array
	
	
		for ($x = 0; $x < count($aryProductsArray); $x++) { //commonize session variable name for products array
	?>
    <fieldset>
		<legend>Product Details</legend>
            ...
            <?php
				...
				$thisProduceItem = $aryProductsArray[$x];
			?>
                ...
                <?php
					switch ($thisProduceItem->price_type) {
						...
						case 2:
							echo "/each";
							break;
					}//added closing curly brace to close switch statement
				?>
			</div>
