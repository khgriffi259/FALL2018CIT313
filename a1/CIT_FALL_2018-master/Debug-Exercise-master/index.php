...
<div id="wrapper">
	...
	<div class="form-container">
		<!-- removed quotes from around url_root -->
    ...
    <fieldset>
		<legend>Product Details: Product <?php echo $x ?></legend>
			...
			<div>
				<label for="productprice<?php echo $x ?>">Product Price</label> $<input id="productprice<?php echo $x ?>" name="productprice<?php echo $x ?>" type="text" size="10" />
			</div>
	</fieldset>
    
    <?php		

	}// changed parenthesis to curly bracket to close for loop
